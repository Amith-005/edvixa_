...
import { AdminDashboardPage, ComingSoonPage, ProfilePage, SubjectsPage, TeacherApprovalsPage, TeacherDashboardPage } from '../features/dashboards/pages'
...
export const router=createBrowserRouter([
  ...
  {element:<ProtectedRoute/>,children:[
    ...
    {element:<RoleRoute roles={['teacher']}/>,children:[{path:'/teacher',element:<PortalLayout/>,children:[{path:'dashboard',element:<TeacherDashboardPage/>},{path:'profile',element:<ProfilePage/>},{path:'slots',element:coming('Manage Slots')},{path:'bookings',element:coming('Booking Requests')},{path:'doubts',element:<TeacherDoubtPollsPage/>},{path:'sessions',element:coming('Session History')},{path:'students',element:coming('Student Progress')},{path:'earnings',element:coming('Earnings')}]}]},
