...
const subjectId = z.string().regex(/^[a-f\d]{24}$/i, 'Invalid subject ID')
export const subjectIdParamsSchema = z.object({ params: z.object({ id: subjectId }) })
export const updateSubjectSchema = z.object({ body: createSubjectSchema.shape.body.partial(), params: z.object({ id: subjectId }) })
