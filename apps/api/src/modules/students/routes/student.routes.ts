...
import { dashboard, fees, leaderboard, progress } from '../controllers/student.controller.js'
...
studentRouter.get('/leaderboard', asyncHandler(leaderboard))
studentRouter.get('/fees', asyncHandler(fees))
